    ...
    <main className={styles.main}>
      <header className={styles.header}>
        <h3 className={styles.headerTopTitle}>
          <span className={styles.headerTopTitleVital}>Forum</span> @Neil
        </h3>
        <h1 className={styles.headerTitle}>Forum project</h1>
        {/* unused stuff */}
      ...
      <section className={styles.copy}>
        <div className={styles.copyInner}>
          <a href="https://github.com/neilsen-ngoi">
